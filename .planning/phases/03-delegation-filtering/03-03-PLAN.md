...
<task type="auto">
  ...
  <action>
Add a complete Gallery pagination pattern section to Control-Patterns-Modern.fx after the Gallery.Items formula pattern added by Plan 03-02 Task 2 (which references FilteredGalleryData composition).
